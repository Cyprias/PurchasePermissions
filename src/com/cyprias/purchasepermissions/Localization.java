...
public class Localization {
	...
	private void loadDefaultKey(String language, String key, String value){
		log.info("[PP] Loading default for " + language + "'s " + key + " value.");
...
//					
				//	log.info("loadDefaultLocales 2 " + language + " " + key + " " + value);

					if (forceLoad == true || !locales.getConfigurationSection(language).isSet(key)){
						loadDefaultKey(language, key, value);
						saveLocales = true;
